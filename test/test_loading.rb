...
class TestLoading < Test::Unit::TestCase
  ...
  context 'Metior' do
    ...
    teardown do
      Object.remove_const :Grit rescue nil
      Object.remove_const :Octokit rescue nil

      Metior.remove_const :Actor rescue nil
      Metior.remove_const :Commit rescue nil
      Metior.remove_const :Repository rescue nil
    end
